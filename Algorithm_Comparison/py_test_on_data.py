...
# vtdel_data = read_struct("/Users/thomaslux/Git/VarSys/TestingAlgs/Results/Output-Delaunay_10-13-2017-MDA_results.csv")
# qhull_data = read_struct("/Users/thomaslux/Git/VarSys/TestingAlgs/Results/Output-qHullDelaunay-MDA_results.csv")
# print(len(vtdel_data))
# print(len(qhull_data))
# bad_idx = np.argmax(abs(vtdel_data["Mean_Guess"] - qhull_data["Mean_Guess"]))
# print(vtdel_data[bad_idx])
# exit()

train_dir = "/Users/thomaslux/Git/VarSys/TestingAlgs/VarSys-2016-Mean_MDA_Data_0/2-R_Size--Threads/96.3--3.7/"
test_dir = "/Users/thomaslux/Git/VarSys/TestingAlgs/VarSys-2016-Mean_MDA_Data_0/2-R_Size--Threads/96.3--3.7/"

for i in range(200):
    train = os.path.join(train_dir, "Train-%i.csv"%i)
    test = os.path.join(test_dir, "Test-%i.csv"%i)
    print(train)

% Algorithm XXX: DELAUNAYSPARSE---Interpolation via a sparse subset of
...
\def\rightrh{Algorithm XXX: DELAUNAYSPARSE}

{\baselineskip=24pt \leftline{\hlvXVIII Algorithm XXX: DELAUNAYSPARSE:}
\leftline{\hlvXVIII Interpolation via a Sparse Subset of the}
\leftline{\hlvXVIII Delaunay Triangulation in Medium to High}
\leftline{\hlvXVIII Dimensions}}
\bigskip\medskip
\leftline{\hlv TYLER H. CHANG, LAYNE T. WATSON, THOMAS C.H. LUX, ALI R. BUTT,}
\smallskip
...
T. H. Chang, T. C. H. Lux, A. R. Butt, K. W. Cameron,
...
e-mail: {\ttVIII thchang@vt.edu}. \xpar
...
{\rmVIII\parindent=0pt DELAUNAYSPARSE contains both serial and

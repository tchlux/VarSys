...
polynomial $f(x)$ on $[X_i, X_{i+1}]$ matching derivatives
$f(X_i)=Y_i$, $Df(X_i)=s \,u_i$, $D^2f(X_i)=s \,v_i$ at $X_i$, and derivatives
$f(X_{i+1})=Y_{i+1}$, $Df(X_{i+1})=s \,u_{i+1}$, $D^2f(X_{i+1})=s \,v_{i+1}$

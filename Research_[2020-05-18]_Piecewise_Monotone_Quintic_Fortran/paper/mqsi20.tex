...
\def\codent{\hskip 1.8em} % <- 'tab' for indentation.
...
at data provided by a quadratic facet model are refined to produce a $C^2$
monotone interpolant.  Algorithm and implementation details, complexity
and sensitivity analyses, usage information, and a brief performance study
are included.

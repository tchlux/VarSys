...
University, Rock Hill, SC 47405; {\ttVIII thackerw@winthrop.edu}.
...
{\caps #1}\ys #2.\ys {\rm #3}. {\sl #4}, #5.\vskip 6pt}
...
\def\refb#1#2#3#4{\noindent\hangindent=10pt\hangafter=1
{\caps #1}\ys #2.\ys{\sl #3}. {\rm #4}.\vskip 6pt}
...
\def\reft#1#2#3#4{\noindent\hangindent=10pt\hangafter=1
{\caps #1}\ys #2.\ys{\rm #3}. {\rm #4}.\vskip 6pt}
...
% cameron2019moana
\refj{Cameron, K. W., Anwar, A., Cheng, Y., Xu, L., Li, B., Ananth, U., Bernard, J., Jearls, C., Lux,  T. C. H., Hong, Y., Watson, L. T., and Butt, A. R.}{2019}{MOANA: Modeling and Analyzing I/O Variability in Parallel System Experimental Design}{IEEE Transactions on Parallel and Distributed Systems}{30(8):1843--1856}
...
\refj{He{\ss}, W. and Schmidt, J. W.}{1994}{Positive quartic, monotone
  quintic $C^2$-spline interpolation in one and two dimensions}{Journal
  of Computational and Applied Mathematics}{55(1):51–-67}
...
\refj{Yao, J. and Nelson, K. E.}{2018}{An Unconditionally Monotone
  $C^2$ Quartic Spline Method with Nonoscillation

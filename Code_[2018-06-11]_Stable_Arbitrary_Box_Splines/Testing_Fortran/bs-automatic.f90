...
SUBROUTINE BOXSPLEV(UNIQUE_DVECS, DVEC_MULTS, EVAL_PTS, BOX_EVALS, ERROR)
  ...
  REAL(KIND=R8), DIMENSION(SIZE(UNIQUE_DVECS,1),SIZE(UNIQUE_DVECS,2),SUM(DVEC_MULTS)-SIZE(UNIQUE_DVECS,1)+2) :: DVECS
  ...
  REAL(KIND=R8), DIMENSION(SIZE(EVAL_PTS,2),                         SUM(DVEC_MULTS)-SIZE(UNIQUE_DVECS,1)+2) :: EVALS_AT_PTS
  REAL(KIND=R8), DIMENSION(SIZE(UNIQUE_DVECS,2),SIZE(EVAL_PTS,2),    SUM(DVEC_MULTS)-SIZE(UNIQUE_DVECS,1)+2) :: SHIFTED_EVAL_PTS
  ! ------------------------------------------------------------------

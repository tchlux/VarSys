...
\begin{figure*}[htb]
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.95\textwidth,height=4cm]{Figures/ACM/eval-times.pdf}};
...
\begin{figure*}
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.95\textwidth,height=9.5cm]{Figures/ACM/all-performance.pdf}};
    \node[below=of img, node distance=0cm, yshift=1cm] {Relative Error Tolerance while Bootstrapping};
...
\begin{figure*}
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.95\textwidth,height=9.5cm]{Figures/ACM/perf-sample.pdf}};

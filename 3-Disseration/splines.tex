...
referred to as {\it shape preserving} \cite{fritsch1980monotone,gregory1985shape}. The specific properties the present algorithm will
...
random numbers from a specified distribution \cite{ramsay1988monotone}.  A spline

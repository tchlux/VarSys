# TODO: Results with 5 and 100 steps show that a solution more nearby
#       the original guess is obtained with fewer (larger)
#       modifications to the first derivative of the function.
# TODO: Implement "smart" step size function to determine the amount
#       of shrinkage that should happen based on the current iterate.

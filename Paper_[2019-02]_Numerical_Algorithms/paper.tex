...
\begin{table}
  ...
  \begin{tabular}{c|r@{.}l|r@{.}l|r@{.}l}
    ...
    SVR & $\mathit{21}$&$\mathit{1}$ & $\mathit{0}$&$\mathit{5}$ & $\mathbf{0}$&$\mathbf{0001}$\\
    MLP & $\mathbf{42}$&$\mathbf{1}$ & $200$&$0$ & $0$&$001$\\
    Delaunay & $6$&$0$ & $1$&$0$ & $1$&$0$\\
    ShepMod & $18$&$4$ & $0$&$7$ & $\mathbf{0}$&$\mathbf{0001}$\\
    LSHEP & $8$&$4$ & $2$&$0$ & $\mathbf{0}$&$\mathbf{0001}$\\
    Voronoi & $0$&$5$ & $\mathbf{0}$&$\mathbf{1}$ & $0$&$04$\\
...
high dimensional problems; and 3) a demonstration that some
interpolants generalize to interpolation in function spaces,
preserving monotonicity (with CDFs, e.g.), neither of which common
regressors can do.
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|r@{.}l| c |r@{.}l|r@{.}l|r@{.}l|}
    ...
    SVR & $\mathbf{80}$&$\mathbf{2}$ &  & $\mathit{0}$&$\mathit{00584}$ & $\mathit{0}$&$\mathit{0000620}$ & $\mathit{0}$&$\mathit{00310}$\\
    ...
    Voronoi & $0$&$0$ &  & $\mathbf{0}$&$\mathbf{000182}$ & $0$&$000396$ & $0$&$0198$\\
...
\begin{table}
  ...
  \begin{tabular}{|c|r@{.}l| c |r@{.}l|r@{.}l|r@{.}l|}
    ...
    SVR & $0$&$1$ &  & $\mathit{0}$&$\mathit{859}$ & $\mathit{0}$&$\mathit{000181}$ & $\mathit{0}$&$\mathit{106}$\\
    ...
    Voronoi & $1$&$6$ &  & $\mathbf{0}$&$\mathbf{298}$ & $0$&$0274$ & $16$&$1$\\
...
\begin{table}
  ...
  \begin{tabular}{|c|r@{.}l| c |r@{.}l|r@{.}l|r@{.}l|}
    ...
    Algorithm & \multicolumn{2}{c|}{\% Best} &  & \multicolumn{2}{c|}{Fit/Prep. Time (s)} & \multicolumn{2}{c|}{App. Time (s)} & \multicolumn{2}{c|}{Total App. Time (s)}\\
    \cline{1-3}\cline{5-10}
    MARS & \,\,\,\,$10$&$7$ &  & \quad\quad\quad$0$&$151$ & \quad$0$&$000117$ & \quad\quad\quad\,\,$0$&$0304$\\
    SVR & $4$&$1$ &  & $\mathit{0}$&$\mathit{133}$ & $\mathbf{0}$&$\mathbf{0000947}$ & $\mathbf{0}$&$\mathbf{0246}$\\
    ...
    Voronoi & $0$&$2$ &  & $\mathbf{0}$&$\mathbf{012}$ & $0$&$0270$ & $7$&$01$\\
...
\begin{table}
  ...
  \begin{tabular}{|c|r@{.}l| c |r@{.}l|r@{.}l|r@{.}l|}
    ...
    SVR & $0$&$0$ &  & $\mathit{1}$&$\mathit{01}$ & $\mathit{0}$&$\mathit{000210}$ & $\mathit{0}$&$\mathit{117}$\\
    ...
    Voronoi & $0$&$0$ &  & $\mathbf{0}$&$\mathbf{197}$ & $0$&$0950$ & $52$&$8$\\
...
\begin{table}
  ...
  \begin{tabular}{|c|r@{.}l| c |r@{.}l|r@{.}l|r@{.}l|}
    ...
    Voronoi & $\mathit{38}$&$\mathit{0}$ &  & $1$&$0$ & $0$&$00253$ & $0$&$762$\\

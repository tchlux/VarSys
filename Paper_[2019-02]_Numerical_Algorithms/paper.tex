...
$b \in \mathbb{R}$ are coefficients to be solved for simultaneously. The
...
uses the scikit-learn SVR \cite{scikit-learn} with a polynomial kernel
function.
...
\begin{proofdot}
  ...
  \leq \sqrt{d} \frac{\gamma k^2}{\sigma_d}.$$ \qed
\end{proofdot}

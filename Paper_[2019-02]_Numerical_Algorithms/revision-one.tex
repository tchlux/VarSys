...
\usepackage{siunitx}  % For table aligned by decimal point
...
their performance with that of popular regression techniques.
Empirical results demonstrate the viability of interpolants for high
dimensional approximation problems, suggesting that these techniques
are capable of effectively modeling multivariate phenomena while
...
A well-studied technique for classification and approximation is the
nearest neighbor algorithm \cite{cover1967nearest}. Nearest neighbor
inherently utilizes the convex region $C^{x^{(i)}}$ (Voronoi cell
\cite{dirichlet1850reduction}) consisting of all points closer to
...
\begin{figure}[htb]
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/plot-delaunay-example-prediction.pdf}};
...
\color{red} This section presents the theoretical results bounding the error of
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/raw-histogram-forest-fire.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth,]{Figures/error-box-forest-fire.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/raw-histogram-parkinsons.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth,]{Figures/error-box-parkinsons.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/raw-histogram-weather.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth,]{Figures/error-box-weather.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/raw-histogram-credit-card.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth,]{Figures/error-box-credit-card.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.75\textwidth,]{Figures/raw-histogram-throughput.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth,]{Figures/error-box-throughput.pdf}};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \node (img)  {\includegraphics[width=0.8\textwidth]{Figures/plot-throughput-ks.pdf}};
...
\begin{table}
  ...
  \begin{tabular}{c|c|c|c}
    \hline
    Algorithm & Avg. \% Best & Avg. Fit / Prep. Time (s) & Avg. App. Time (s)\\
    \hline
    MARS & $4.6$ & $22.3$ & $1.37 \times 10^{-3}$\\
    SVR & $\mathit{21.1}$ & $0.503$ & $\mathit{1.37 \times 10^{-4}}$\\
    MLP & $\mathbf{42.1}$ & $210.0$ & $1.02 \times 10^{-3}$\\
    Delaunay & $6.0$ & $\mathbf{1.43 \times 10^{-4}}$ & $3.03$\\
    ShepMod & $18.4$ & $0.711$ & $1.49 \times 10^{-4}$\\
    LSHEP & $8.4$ & $1.69$ & $\mathbf{1.16 \times 10^{-4}}$\\
    Voronoi & $0.5$ & $\mathit{0.127}$ & $0.0375$\\
    BoxSplines & $0.2$ & $0.816$ & $5.26 \times 10^{-4}$\\
    \hline
  \end{tabular}
...
data points for the dimension (for empirical results presented,
$\log_d n \leq 5$).
...
\begin{table}
  ...
  \begin{tabular}{|c|c| c |c|c|c|}
    ...
    \cline{1-2}\cline{4-6}
    MARS & $\mathit{7.7}$ &  & $29.1$ & $1.37 \times 10^{-3}$ & $0.0686$\\
    SVR & $\mathbf{80.2}$ &  & $5.84 \times 10^{-3}$ & $\mathit{6.20 \times 10^{-5}}$ & $\mathit{3.10 \times 10^{-3}}$\\
    MLP & $0.0$ &  & $32.8$ & $8.71 \times 10^{-4}$ & $0.0436$\\
    Delaunay & $3.5$ &  & $\mathbf{2.49 \times 10^{-5}}$ & $0.0385$ & $1.93$\\
    ShepMod & $3.7$ &  & $6.34 \times 10^{-3}$ & $6.44 \times 10^{-5}$ & $3.22 \times 10^{-3}$\\
    LSHEP & $5.1$ &  & $0.0275$ & $\mathbf{4.63 \times 10^{-5}}$ & $\mathbf{2.31 \times 10^{-3}}$\\
    Voronoi & $0.0$ &  & $\mathit{1.82 \times 10^{-4}}$ & $3.96 \times 10^{-4}$ & $0.0198$\\
    BoxSpline & $0.4$ &  & $7.24 \times 10^{-3}$ & $9.78 \times 10^{-5}$ & $4.89 \times 10^{-3}$\\
    \cline{1-2}\cline{4-6}
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{|c|c| c |c|c|c|}
    ...
    Algorithm & \% Best &  & Fit / Prep. Time (s) & App. Time (s) & Total App. Time (s)\\
    \cline{1-2}\cline{4-6}
    MARS & $0.0$ &  & $37.9$ & $2.53 \times 10^{-3}$ & $1.48$\\
    SVR & $0.1$ &  & $0.859$ & $\mathit{1.81 \times 10^{-4}}$ & $\mathit{0.106}$\\
    MLP & $\mathit{32.0}$ &  & $348.0$ & $1.11 \times 10^{-3}$ & $0.653$\\
    Delaunay & $0.0$ &  & $\mathbf{1.90 \times 10^{-4}}$ & $3.69$ & $2.17 \times 10^{3}$\\
    ShepMod & $\mathbf{66.4}$ &  & $1.13$ & $1.82 \times 10^{-4}$ & $0.107$\\
    LSHEP & $0.0$ &  & $2.39$ & $\mathbf{1.44 \times 10^{-4}}$ & $\mathbf{0.0845}$\\
    Voronoi & $1.6$ &  & $\mathit{0.298}$ & $0.0274$ & $16.1$\\
    BoxSpline & $0.0$ &  & $1.26$ & $6.43 \times 10^{-4}$ & $0.377$\\
    \cline{1-2}\cline{4-6}
  \end{tabular}
  \caption{The left above shows how often each algorithm had the
...
\begin{table}
  ...
  \begin{tabular}{|c|c| c |c|c|c|}
    ...
    Algorithm & \% Best &  & Fit / Prep. Time (s) & App. Time (s) & Total App. Time (s)\\
    \cline{1-2}\cline{4-6}
    MARS & $10.7$ &  & $0.151$ & $1.17 \times 10^{-4}$ & $0.0304$\\
    SVR & $4.1$ &  & $0.133$ & $\mathbf{9.47 \times 10^{-5}}$ & $\mathbf{0.0246}$\\
    MLP & $\mathbf{56.8}$ &  & $169.0$ & $1.37 \times 10^{-3}$ & $0.356$\\
    Delaunay & $0.1$ &  & $\mathbf{1.16 \times 10^{-4}}$ & $1.55$ & $403.0$\\
    ShepMod & $3.5$ &  & $0.265$ & $1.28 \times 10^{-4}$ & $0.0333$\\
    LSHEP & $\mathit{28.4}$ &  & $0.874$ & $\mathit{9.75 \times 10^{-5}}$ & $\mathit{0.0254}$\\
    Voronoi & $0.2$ &  & $\mathit{0.0112}$ & $0.0270$ & $7.01$\\
    BoxSpline & $0.3$ &  & $0.330$ & $4.06 \times 10^{-4}$ & $0.106$\\
    \cline{1-2}\cline{4-6}
  \end{tabular}
  \caption{The left above shows how often each algorithm had the
...
\begin{table}
  ...
  \begin{tabular}{|c|c| c |c|c|c|}
    ...
    Algorithm & \% Best &  & Fit / Prep. Time (s) & App. Time (s) & Total App. Time (s)\\
    \cline{1-2}\cline{4-6}
    MARS & $0.0$ &  & $22.0$ & $1.48 \times 10^{-3}$ & $0.820$\\
    SVR & $0.0$ &  & $1.01$ & $\mathit{2.10 \times 10^{-4}}$ & $\mathit{0.117}$\\
    MLP & $\mathbf{79.5}$ &  & $290.0$ & $7.14 \times 10^{-4}$ & $0.397$\\
    Delaunay & $\mathit{20.5}$ &  & $\mathbf{2.43 \times 10^{-4}}$ & $6.83$ & $3.80 \times 10^{3}$\\
    ShepMod & $0.1$ &  & $1.45$ & $2.20 \times 10^{-4}$ & $0.122$\\
    LSHEP & $0.0$ &  & $3.47$ & $\mathbf{1.76 \times 10^{-4}}$ & $\mathbf{0.0981}$\\
    Voronoi & $0.0$ &  & $\mathit{0.197}$ & $0.0950$ & $52.8$\\
    BoxSpline & $0.0$ &  & $1.66$ & $9.56 \times 10^{-4}$ & $0.532$\\
    \cline{1-2}\cline{4-6}
  \end{tabular}
  \caption{The left above shows how often each algorithm had the
...
\begin{table}
  ...
  \begin{tabular}{|c|c| c |c|c|c|}
    ...
    Algorithm & \% Best &  & Fit / Prep. Time (s) & App. Time (s) & Total App. Time (s)\\
    \cline{1-2}\cline{4-6}
    Delaunay & $\mathbf{62.0}$ &  & $\mathbf{5.17 \times 10^{-4}}$ & $0.353$ & $106.0$\\
    ShepMod & $0.0$ &  & $0.0884$ & $\mathbf{1.45 \times 10^{-4}}$ & $\mathbf{0.0436}$\\
    Voronoi & $\mathit{38.0}$ &  & $\mathit{0.0173}$ & $2.53 \times 10^{-3}$ & $0.762$\\
    BoxSpline & $0.0$ &  & $0.0972$ & $\mathit{2.10 \times 10^{-4}}$ & $\mathit{0.0633}$\\
    \cline{1-2}\cline{4-6}
  \end{tabular}
  \caption{The left above shows how often each algorithm had the
